 ...
 * @since Sep 2, 2003
 */
public class ORCAClosestFirstIterator<V, E>
        extends CrossComponentIterator<V,
        E, FibonacciHeapNode<ORCAClosestFirstIterator.QueueEntry<V, E>>> {
    //~ Instance fields --------------------------------------------------------

    /**
     * Priority queue of fringe vertices.
     */
    protected FibonacciHeap<QueueEntry<V, E>> heap =
     ...
     */
    public ORCAClosestFirstIterator(Graph<V, E> g) {
        this(g, null);
    }
     ...
     */
    public ORCAClosestFirstIterator(Graph<V, E> g, V startVertex) {
     ...
     *                    unbounded search.
     */
    public ORCAClosestFirstIterator(Graph<V, E> g, V startVertex, double radius) {
        super(g, startVertex);
        this.radius = radius;
    ...
    protected void assertNonNegativeEdge(E edge) {
     ...
     */
    protected FibonacciHeapNode<QueueEntry<V, E>> createSeenData(
            V vertex,
            E edge) {
     ...
     */
    protected static class QueueEntry<V, E> {
        /**
